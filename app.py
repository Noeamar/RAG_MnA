...
from poc_RAG import (rag_fusion, rag_fusion_actualites, rag_fusion_fonds,
...
# If the user is registered but not yet accessing the app, show a button to proceed
...
if st.session_state["registered"] and st.session_state["ready_to_access"]:
    ...
    menu = st.sidebar.radio(
        "Navigation",
        options=["Home", "Comprehensive Data (News+Companies+Funds)", "News", "Funds", 
    ...
    if menu == "Home":
        ...
        st.write(
            """
            Ask a question here, and the AI will query the full database, 
            including news, companies, and funds.
            """
        )
        ...
        st.write(
            """
            Ask a question here, and the AI will query the dedicated news database.
            """
        )
        ...
        st.write(
            """
            Ask a question here, and the AI will query the dedicated funds database.
            """
        )
        ...
        st.write(
            """
            Ask a question here, and the AI will query the database dedicated to comparable transactions 
            and financial multiples.
            """
        )
